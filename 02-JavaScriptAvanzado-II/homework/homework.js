...
function cacheFunction(cb) {
  ...
  var objeto = {};  //  creo la variable objeto
  return function cache(argumento) {          // retorno la function
    if (objeto.hasOwnProperty(argumento)) {   // si existe el dato o argumento en la cache lo retorna
      return objeto[argumento]
    }
    return cb(argumento)            // si no existe en cache llama a la function cb pasandole el argumento para retornar el resultado de la function cb
